...
import {IoCloseOutline, IoCloudOfflineOutline, IoInformation} from "react-icons/io5"
...
import {StatisticsPreviewRow, StatisticsPreviewRowSkeleton} from "@/entities/statistics"
			...
			<div className="h-full flex flex-col">
				<div className="flex items-center justify-between p-6">
					<div className="flex items-center gap-x-6 font-semibold text-sm text-gray-700">
						Статистика: {windowStart && dayjs(windowStart).format("LL")}
					</div>
					<MyButton
						onClick={onClose}
						variant="default"
							...
							<MyTable>
								...
								<MyTableHead className="sticky top-[-1px] z-10">
									<MyTableRow>
										...
										<MyTableCell>
											<div className="flex items-center justify-center gap-x-2">Подписки</div>
										</MyTableCell>
										<MyTableCell>
											<div className="flex items-center justify-center gap-x-2">Отписки</div>
										</MyTableCell>
										<MyTableCell>
											<div className="flex items-center justify-center gap-x-2">Диалоги</div>
										</MyTableCell>
										<MyTableCell>
											<Tooltip
												placement="top-end"
